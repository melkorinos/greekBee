...
export const ANSWER_META: Readonly<Record<string, CuratedAnswerMeta>> = {
  ...
  "donousa": { name: "Δονούσα", capital: "Σταυρός", capitalCoord: [25.8117, 37.0906], region: "Νοτίου Αιγαίου", isIsland: true, aliases: [] },
  ...
  "iraklia": { name: "Ηρακλειά", capital: "Άγιος Γεώργιος", capitalCoord: [25.4497, 36.8397], region: "Νοτίου Αιγαίου", isIsland: true, aliases: [] },
  "ithaca": { name: "Ιθάκη", capital: "Βαθύ", capitalCoord: [20.7202, 38.3647], region: "Ιονίων Νήσων", isIsland: true, aliases: [] },
  "kalamos": { name: "Κάλαμος", capital: "Κάλαμος", capitalCoord: [20.9269, 38.6231], region: "Ιονίων Νήσων", isIsland: true, aliases: [] },
  ...
  "koufonisia": { name: "Κουφονήσια", capital: "Χώρα Κουφονησίων", capitalCoord: [25.6086, 36.9372], region: "Νοτίου Αιγαίου", isIsland: true, aliases: ["κουφονησι", "ανω κουφονησι"] },
  ...
  "schoinoussa": { name: "Σχοινούσα", capital: "Χώρα Σχοινούσας", capitalCoord: [25.5175, 36.8636], region: "Νοτίου Αιγαίου", isIsland: true, aliases: [] },
