...
export const SEED_BRANDS = [
  ...
  },
  {
    ...
    brand: "Βορεία",
    sector: "Υγρά",
    accept: ["Βορεία", "Βορεια", "Voreia"],
    search: ["Voreia beer logo"],
  },
  {
    id: "korfi",
    brand: "Κορφή",
    sector: "Υγρά",
    accept: ["Κορφή", "Κορφη", "Korfi"],
    search: ["Korfi beer logo"],
  },
  {
    id: "amstel",
    brand: "Amstel",
  ...
  },
  {
    ...
    brand: "Τσάνταλη",
    sector: "Υγρά",
    accept: ["Τσάνταλη", "Τσανταλη", "Tsantali", "Τσάνταλης"],
    search: ["Tsantali logo"],
  },
  {
    id: "kourtaki",
    brand: "Κουρτάκη",
    sector: "Υγρά",
    accept: ["Κουρτάκη", "Κουρτακη", "Kourtaki", "Κουρτάκης"],
    search: null,
    note: "MANUAL — only greek-wine-cellars.com touch-icons; the Κουρτάκη label mark is not online.",
  },
  {
    id: "malamatina",
    brand: "Μαλαματίνα",
  ...
  },
  {
    ...
    brand: "Cavino",
    sector: "Υγρά",
    accept: ["Cavino", "Καβίνο", "Καβινο"],
    search: ["Cavino winery logo"],
  },
  {
    id: "lazaridi",
  ...
  },
  {
    ...
    brand: "Λουτράκι",
    sector: "Υγρά",
    accept: ["Λουτράκι", "Λουτρακι", "Loutraki", "Νερό Λουτράκι"],
    search: ["Loutraki water logo"],
  },
  {
    id: "korpi",
    brand: "Κορπή",
  ...
  },
  {
    ...
    brand: "Καϊάφας",
    sector: "Υγρά",
    accept: ["Καϊάφας", "Καιαφας", "Kaiafas"],
    search: ["Kaiafas water logo"],
  },
  {
    id: "doubles",
    brand: "Δουμπιά",
  ...
  },
  {
    ...
    brand: "Molto",
    sector: "Τρόφιμα",
    accept: ["Molto", "Μόλτο", "Μολτο"],
    search: ["Molto Chipita logo", "Molto croissant logo"],
  },
  {
    id: "tsakiris",
    brand: "Τσακίρης",
  ...
  },
  {
    ...
    brand: "Τρικαλινός",
    sector: "Τρόφιμα",
    accept: ["Τρικαλινός", "Τρικαλινος", "Trikalinos"],
    search: ["Trikalinos logo"],
  },
  {
    id: "minerva",
    brand: "Μινέρβα",
  ...
  },
  {
    ...
    brand: "McDonald's",
    sector: "Εστίαση",
    accept: ["McDonald's", "McDonalds", "Μακντόναλντς", "Μακ Ντόναλντς", "MacDonalds"],
    search: ["McDonald's logo"],
    note: "The golden arches are the canonical icon-only mark.",
  },
  {
    id: "kfc",
    brand: "KFC",
    sector: "Εστίαση",
    accept: ["KFC", "Κέι Εφ Σι", "Kentucky Fried Chicken"],
    search: ["KFC logo"],
  },
  {
    id: "dominos",
    ...
    sector: "Εστίαση",
    accept: ["Domino's", "Dominos", "Domino's Pizza", "Ντόμινος", "Ντομινος"],
    search: ["Domino's Pizza logo"],
  },
  {
    id: "pizza-fan",
    brand: "Pizza Fan",
  ...
  },
  {
    ...
    brand: "Pizza Hut",
    sector: "Εστίαση",
    accept: ["Pizza Hut", "Πίτσα Χατ", "Πιτσα Χατ"],
    search: ["Pizza Hut logo"],
  },
  {
    id: "ta-adelfia",
    brand: "Τα Αδέρφια",
    sector: "Εστίαση",
    accept: ["Τα Αδέρφια", "Τα Αδερφια", "Ta Aderfia", "Τα Αδέλφια"],
    search: ["Ta Aderfia souvlaki logo"],
  },
  {
    id: "kotobiky",
    brand: "Κοτομπάιτς",
    sector: "Εστίαση",
    accept: ["Κοτομπάιτς", "Κοτομπαιτς", "Kotobites"],
    search: ["Kotobites logo"],
  },
  {
    id: "simply-burgers",
  ...
  {
    id: "gregorys",
    brand: "Grigoris Coffee",
    sector: "Εστίαση",
    accept: ["Γρηγόρης Coffee", "Grigoris Coffee", "Γρηγόρης Καφές"],
    search: ["Grigoris coffee logo"],
  },
  {
    id: "coffee-lab",
    brand: "Coffee Lab",
  ...
  },
  {
    ...
    brand: "Coffeeright",
    sector: "Εστίαση",
    accept: ["Coffeeright", "Κοφιράιτ", "Coffee right"],
    search: ["Coffeeright logo"],
  },
  {
    id: "second-cup",
    brand: "Second Cup",
  ...
  },
  {
    ...
    brand: "Cosmos Sport",
    sector: "Εταιρείες",
    accept: ["Cosmos Sport", "Κόσμος Σπορ", "CosmosSport"],
    search: ["Cosmos Sport logo"],
  },
  {
    id: "sklavenitis-cash",
    brand: "The Mart",
  ...
  },
  {
    ...
    brand: "Winmasters",
    sector: "Τυχερά παιχνίδια",
    accept: ["Winmasters", "Γουινμάστερς", "Win masters"],
    search: ["Winmasters logo"],
  },
  {
    id: "netbet",
    brand: "NetBet",
  ...
  },
  {
    ...
    brand: "Σφαίρα 102.2",
    sector: "Μέσα ενημέρωσης",
    accept: ["Σφαίρα", "Σφαιρα", "Sfera", "Σφαίρα 102.2", "Sfera 102.2"],
    search: ["Sfera 102.2 radio Athens logo", "Σφαίρα ραδιόφωνο logo"],
  },
  {
    id: "athens-deejay",
    brand: "Athens DeeJay",
  ...
  },
  {
    ...
    brand: "Καραλής",
    sector: "Τρόφιμα",
    accept: ["Καραλής", "Καραλης", "Karalis"],
    search: ["Karalis allantika logo"],
  },
  {
    id: "eyellinikon",
    brand: "Ευ Ελληνικόν",
    sector: "Τρόφιμα",
    accept: ["Ευ Ελληνικόν", "Ευ Ελληνικον", "Ef Ellinikon"],
    search: ["Ef Ellinikon logo"],
  },
  {
    id: "olympus-tyri",
    brand: "Τυράς",
  ...
  },
  {
    ...
    brand: "Ρούσσας",
    sector: "Τρόφιμα",
    accept: ["Ρούσσας", "Ρουσσας", "Roussas"],
    search: ["Roussas cheese logo"],
  },
];
