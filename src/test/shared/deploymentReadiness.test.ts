...
const STATICALLY_IMPORTED_DATA_FILES = [
  ...
  // Leksikastirio nomination blocklist — proper nouns / months / places / foreign
  // words players may not propose adding. Statically imported by the edge
  // nomination routes via @/lib/nominationBlocklist (~60 KB gzipped).
  "src/data/nominations-blocklist.json",
];
