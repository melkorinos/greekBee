...
const GAME_RULES = {
  ...
  leksodromia: {
    ...
    rules: [
      ...
      "Αν κολλήσεις, κάνε **παράλειψη** — η λέξη αποκαλύπτεται για 0 πόντους.",
  ...
  leksoplegma: {
    ...
    rules: [
      ...
      "Όταν βρίσκεις μια λέξη, τα γράμματα που δεν χρειάζονται πια **εξαφανίζονται**.",
      "Κάθε λέξη δίνει **10 πόντους ανά γράμμα** — χωρίς ρολόι, με την ησυχία σου.",
      "Στο πλέγμα κρύβονται κι **έξτρα λέξεις** (+25 η καθεμία) — εκεί κερδίζεται ο πίνακας σκορ.",
