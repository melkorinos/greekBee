 ...
 * badge. The inner divider went with the 🥉🥈🥇 medal (TICKET-03): the tier is now
 * the mark's own frame, so there is one thing inside the chip, not two.
 * Owns colour/spacing/radius only; the row cell owns layout. */
export const lbBadgeChip =
  "inline-flex items-center ml-1.5 pl-1.5 border-l border-border align-middle leading-none";
