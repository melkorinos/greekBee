...
// LogopaignioGiveUpModal — confirmation prompt for giving up (mirrors the
// posokanei pattern). Confirming ends the round; the revealed brand + clear mark
...
interface LogopaignioGiveUpModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}
...
export function LogopaignioGiveUpModal({ isOpen, onClose, onConfirm }: LogopaignioGiveUpModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} closeLabel="Κλείσιμο">
      ...
      <p className="text-sm text-muted mb-6">
        Θα δεις ποια εταιρεία ήταν. Είσαι σίγουρος/η;
      </p>
