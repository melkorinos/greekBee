  ...
  return (
    <>
      ...
      {isRoundEnd && (
        ...
        >
{/* The reveal line, subordinate to the score heading the panel puts above
              it. It reports how many of the five Lengths were SOLVED, not that all
              five were reached — reaching Round End with two words found and three
              missed is a different day from a clean sweep, and "Ολοκλήρωσες και τα
              5 μήκη" told them apart not at all. Zero is a real outcome and reads
              plainly. */}
