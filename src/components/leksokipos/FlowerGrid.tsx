...
export const DEFAULT_PIE_CONFIG: FlowerGridConfig = {
  variant: "pie",
  rCenter: 50,
  segFontSize: 27,
  centerFontSize: 30,
  ...
  petalGradEnd: "#72B882",
  centerFillColor: "#e2bbfd",
  centerStrokeColor: "#cd6bf8",
  centerTextColor: "#fffd9d",
  centerGradStart: "#D4855A",
  centerGradEnd: "#B86844",
};

export const DEFAULT_FLOWER_CONFIG: FlowerGridConfig = {
  variant: "flower",
  rCenter: 38,
  segFontSize: 25,
  centerFontSize: 25,
  ...
  segGradStart: "#D8C4A8",
  segGradEnd: "#EDE0CE",
  petalFillColor: "#fffbe1",
  petalStrokeColor: "#faf7c0",
  petalTextColor: "#2D5A36",
  petalGradStart: "#C4EACC",
  petalGradEnd: "#72B882",
  centerFillColor: "#f8add5",
  centerStrokeColor: "#f799ca",
  centerTextColor: "#000000",
  centerGradStart: "#D4855A",
  centerGradEnd: "#B86844",
};

export const DEFAULT_CONFIG = DEFAULT_PIE_CONFIG;
