...
- **13 tables, all RLS-enabled** (`public.` schema): `game_scores` (~220), `game_state` (~90), `nominations`, `nomination_votes`, `player_profiles`, `player_achievements`, `player_pangrams` (newest, migration `20260706120000`), `transfer_codes`, `identity_audit`, and 4 `community_*_puzzles`. (Re-verified live 2026-07-17.)
