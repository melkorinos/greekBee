...
> Read this before any skill maintenance: `npx skills` update/add/delete, forking a skill, or restoring the built-in `/code-review`. Not needed for merely *using* skills — the CLAUDE.md table covers that. Moved out of CLAUDE.md 2026-07-18.
...
**Pruning history:** the CLAUDE.md table became the whole list on 2026-07-16 (42 skill folders → 14). Upstream dropped `caveman` and `zoom-out` with no replacement (removed here, 2026-07-14).
