...
6. **E2E coverage** — Playwright is wired (`npm run test:e2e`). **Settled 2026-08-11:** the launch
   gate is the *existing* suite green, not a bigger one. The three Tier A happy paths carved out of
   that deferral all shipped 2026-08-21 (Βρες τη Φράση, Λεξοδρομία, Λεξόπλεγμα) and the issue was
   closed with them; what stays undone — Stavrolekso, Τοποθεσίες, Λεξικαστήριο, a mobile viewport,
   dark mode — is costed in `.claude/aiHelper/e2e-coverage/analysis.md` and nothing tracks it.
